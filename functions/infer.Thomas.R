...
# pattern  - point pattern specified using simWind
# startpar - initial parameters for the search algorithm (see thomas.estK in spatstat)

# returns a vector containing parentIntensity, sigma, meanClusterSize, respectively
