...
output <- foreach(l=1:N, .combine=cbind, .export = c("simWind", "angleMatrix", "xScalingFactor", "rDirLine", "KofA", "Lest",
                                                     ...
                                                     "as.ppp", "r.grid.W",  "vGtile.W", "vKtile.W"),
...
write.csv(output, "PLCP_ORACLE_1_SMALL_short.csv")
...
write.csv(output, "PLCP_ORACLE_08_SMALL_short.csv")
...
write.csv(output, "PLCP_ORACLE_06_SMALL_short.csv")
...
write.csv(output, "PLCP_ORACLE_04_SMALL_short.csv")
