...
write.csv(output, "PLCP_ORACLE_1_BIG_short.csv")
...
write.csv(output, "PLCP_ORACLE_08_BIG_short.csv")
...
write.csv(output, "PLCP_ORACLE_06_BIG_short.csv")
...
write.csv(output, "PLCP_ORACLE_04_BIG_short.csv")
