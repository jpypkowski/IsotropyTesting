...
} #updated after simulation; worked without an update for ensuring n>2
...
output <- foreach(l=1:N, .combine=cbind, .export = c("simWind", "angleMatrix","xScalingFactor", "rDirLine", "KofA", "Lest", "sqrt.n",
                                                     "testAniso","cylK", "GLoc", "periodogram", "thetaSpectrum", "stchRecH", "rvonmises",
...
write.csv(output, "PLCP_06_TILING_5_SMALL.csv")