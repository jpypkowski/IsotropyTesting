...
# write.csv(output, "PLCP_ORACLE_1_SMALL.csv")
...
write.csv(output, "PLCP_ORACLE_08_SMALL.csv")
...
# write.csv(output, "PLCP_ORACLE_06_SMALL.csv")
...
write.csv(output, "PLCP_ORACLE_04_SMALL.csv")
