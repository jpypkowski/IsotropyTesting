...
write.csv(output, "PLCP_ORACLE_1_BIG.csv")
...
write.csv(output, "PLCP_ORACLE_08_BIG.csv")
...
write.csv(output, "PLCP_ORACLE_06_BIG.csv")
...
write.csv(output, "PLCP_ORACLE_04_BIG.csv")
