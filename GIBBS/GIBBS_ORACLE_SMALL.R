...
output <- foreach(l=1:N, .combine=cbind, .export = c("simWind", "angleMatrix", "Lest",
                                                     "testAniso","cylK", "GLoc", "periodogram", "thetaSpectrum",
...
write.csv(output, "GIBBS_ORACLE_1_SMALL.csv")
...
write.csv(output, "GIBBS_ORACLE_08_SMALL.csv")
...
write.csv(output, "GIBBS_ORACLE_06_SMALL.csv")
...
write.csv(output, "GIBBS_ORACLE_04_SMALL.csv")
