...
write.csv(output, "GIBBS_ORACLE_1_BIG.csv")
...
write.csv(output, "GIBBS_ORACLE_08_BIG.csv")
...
write.csv(output, "GIBBS_ORACLE_06_BIG.csv")
...
write.csv(output, "GIBBS_ORACLE_04_BIG.csv")
