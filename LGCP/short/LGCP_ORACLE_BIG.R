...
vGtile.W <- vKtile.W <- matrix(NA, nrow=36, ncol=M)
for(i in 1:M){
  set.seed(seeds[i])
...
write.csv(output, "LGCP_ORACLE_1_BIG_short.csv")
...
write.csv(output, "LGCP_ORACLE_08_BIG_short.csv")
...
write.csv(output, "LGCP_ORACLE_06_BIG_short.csv")
...
write.csv(output, "LGCP_ORACLE_04_BIG_short.csv")
