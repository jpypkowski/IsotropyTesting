...
write.csv(output, "LGCP_ORACLE_1_SMALL_short.csv")
...
write.csv(output, "LGCP_ORACLE_08_SMALL_short.csv")
...
write.csv(output, "LGCP_ORACLE_06_SMALL_short.csv")
...
write.csv(output, "LGCP_ORACLE_04_SMALL_short.csv")
