...
output <- foreach(l=1:N, .combine=cbind, .export = c("simWind", "angleMatrix","xScalingFactor", "rLGCPtransformed", "rLGCP", "Lest", "rmvnorm",
                                                     "testAniso","cylK", "GLoc",  "model",
                                                     "owin", "xdim", "ydim", "var", "scale", "mu", "thomas.estpcf", "rAnisotrop",
...
write.csv(output, "LGCP_THOMAS_04_SMALL_long_short.csv")