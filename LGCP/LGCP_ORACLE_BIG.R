...
write.csv(output, "LGCP_ORACLE_1_BIG.csv")
...
write.csv(output, "LGCP_ORACLE_08_BIG.csv")
...
write.csv(output, "LGCP_ORACLE_06_BIG.csv")
...
write.csv(output, "LGCP_ORACLE_04_BIG.csv")
